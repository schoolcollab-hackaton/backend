...
class UtilisateurRole(Model):
    id = fields.IntField(pk=True)
    utilisateur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="user_roles"
    )
...
class Publication(Model):
    id = fields.IntField(pk=True)
    titre = fields.CharField(max_length=200)  # New title field
...
class Groupe(Model):
    ...
    centreInteret = fields.ForeignKeyField(
        "models.CentreInteret", related_name="groupes"
    )
...
class UtilisateurParrainage(Model):
    id = fields.IntField(pk=True)
    utilisateur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="parrainages"
    )
    parrainage = fields.ForeignKeyField(
        "models.Parrainage", related_name="utilisateurs"
    )
...
class UtilisateurCentreInteret(Model):
    id = fields.IntField(pk=True)
    utilisateur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="centres_interet"
    )
    centreInteret = fields.ForeignKeyField(
        "models.CentreInteret", related_name="utilisateurs"
    )
...
class DemandeSoutien(Model):
    id = fields.IntField(pk=True)
    demandeur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="demandes_soutien"
    )
    helper = fields.ForeignKeyField(
        "models.Utilisateur", related_name="aides_fournies", null=True
    )
...
class ScoreAction(Model):
    ...
    date = fields.DatetimeField(auto_now_add=True)
    utilisateur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="score_actions"
    )
...
class UtilisateurPublication(Model):
    id = fields.IntField(pk=True)
    utilisateur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="interactions_publications"
    )
    publication = fields.ForeignKeyField(
        "models.Publication", related_name="interactions"
    )
...
class UtilisateurGroupe(Model):
    id = fields.IntField(pk=True)
    utilisateur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="groupes_membre"
    )
...
class UtilisateurCompetence(Model):
    id = fields.IntField(pk=True)
    utilisateur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="competences"
    )
    competence = fields.ForeignKeyField(
        "models.Competence", related_name="utilisateurs"
    )
...
class Message(Model):
    ...
    contenu = fields.TextField()
    date = fields.DatetimeField(auto_now_add=True)
    expediteur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="messages_envoyes"
    )
    destinataire = fields.ForeignKeyField(
        "models.Utilisateur", related_name="messages_recus"
    )
...
class HistoriqueChatbot(Model):
    id = fields.IntField(pk=True)
    utilisateur = fields.ForeignKeyField(
        "models.Utilisateur", related_name="historique_chatbot"
    )
    question = fields.TextField()
    reponse = fields.TextField()
    dateInteraction = fields.DatetimeField(auto_now_add=True)
    referenceBase = fields.ForeignKeyField(
        "models.BaseConnaissance", related_name="historiques", null=True
    )
